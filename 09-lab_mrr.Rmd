# Lab 5: Mark-Release-Recapture with *Heliconius* {#Lab_MRR}
...
The basic method, from which most modern population size estimation procedures have evolved (Lincoln-Pearson), involves at least two sampling periods.
...
Assumptions of the Lincoln-Pearson method:
...
One allele (F) accounts for the red, orange, red or brown scales in the discal forewing band (beyond the large wing cell).
Another allele (H) controls the presence of such scales on the hind wing and/or on the proximal FW in the cell region.
We will use these genotypes to estimate whether the population is in **Hardy-Weinberg Equilbirum**
...
#### Genotype frequencies at equilbrium
...
I'll be providing some code that shows how to do this.
