...
The R code used to generate all of the figures in this chapter can be
found
\href{https://github.com/Christopher-Peterson/Bio373L-Book/blob/master/R/figures_chapter_scripts.r}{here}
(along with some annotations). I've tried to explain what most of the
components of each plot do, though I'd recommend learning some basic
\texttt{ggplot2} first.
