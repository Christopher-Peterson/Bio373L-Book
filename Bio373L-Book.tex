...
\section{Writing Lab Reports: Structure}\label{structure}

\subsection{Structure Overview}\label{structure-overview}
...
\subsubsection{Reporting statistics}\label{reporting-statistics}
...
\subsubsection{Do not interpret your data
...
\subsection{Common Mistakes for particular
...
\section{Writing Lab Reports: Style}\label{style}
...
\subsection{Passive Voice}\label{passive-voice}
...
\subsection{Word Choice}\label{word-choice}
...
\subsection{Scientific and Common
Names}\label{scientific-and-common-names}
...
\subsection{Other Grammar}\label{other-grammar}
...
\subsection{Tenses}\label{tenses}
...
\subsubsection{Be Concise}\label{be-concise-1}
...
\subsection{Some Example Figures}\label{some-example-figures}

\subsubsection{General Formatting}\label{general-formatting}
...
\subsubsection{Continuous response, categorical
...
\subsubsection{Categorical, count, or frequency
