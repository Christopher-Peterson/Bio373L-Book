...
To collect data we will establish transects in three areas of interest: the **lower river terrace**, the **old pastures (experimental plots)** and the **quarry zone** (see figure \@ref(fig:bflHabMapCap) for a map).
...
knitr::include_graphics("https://bfl.utexas.edu/images/BFL/habitats_2013.jpg")
```
...
In each habitat, each team will establish 3 sample points which are randomly determined along a transect line. 
Transect lines will be set by the instructors.
Note: Areas recently cleared or plowed will be excluded.
