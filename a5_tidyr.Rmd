...
We're going to be using some new datasets for this chapter: [succession_wide.csv]() (which is a modified version of a previous semester's lab1 data), ...
Please download and put all of them in your "example_data" directory.  
...
Let's look at the succession data:
...
## Pivoting multiple columns {#pivot-longer-multi}
