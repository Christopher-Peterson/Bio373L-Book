...
Information on the data-analysis techniques you'll need to use can be found in Chapter \@ref(r-intro), Chapters \@ref(r_ggplot), Chapters \@ref(r_dplyr), and Chapter \@ref(r_stats) up to and including Section \@ref(r_stats_cat).
