...
Information on the data-analysis techniques you'll need to use can be found in Chapter \@ref(r-intro), Chapters \@ref(r-ggplot), Chapters \@ref(r-dplyr), and Chapter \@ref(r-stats) up to and including Section \@ref(r-stats-cat).
