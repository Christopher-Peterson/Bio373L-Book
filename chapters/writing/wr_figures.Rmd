...
The R code used to generate all of the figures in this chapter can be found [here](https://github.com/Christopher-Peterson/Bio373L-Book/blob/master/R/figures_chapter_scripts.r) (along with some annotations).  I've tried to explain what most of the components of each plot do, though I'd recommend learning some basic `ggplot2` first.
