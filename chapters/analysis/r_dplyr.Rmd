# Data manipulation with `dplyr` {#r_dplyr}
...
## Adding/modifying columns (mutate) {#r_dplyr_mutate}
...
## Subsetting by row (filter) {#r_dplyr_filter}
...
## Subsetting by column (select) {#r_dplyr_select}
...
## Sorting by columns (arrange) {#r_dplyr_arrange}
...
## Summarizing data {#r_dplyr_summarize}
...
## Group Operations {#r_dplyr_group}
